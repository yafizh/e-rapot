                                    ...
                                    <?php while ($row = $result->fetch_assoc()) : ?>
                                        <tr>
                                            ...
                                            <td class="text-center td-fit">
                                                <a target="_blank" href="halaman/cetak/kelas_aktif-siswa.php?id=<?= $row['id']; ?>" class="btn btn-sm btn-success">Cetak Siswa</a>
                                                <a target="_blank" href="halaman/cetak/kelas_aktif-mata_pelajaran.php?id=<?= $row['id']; ?>" class="btn btn-sm btn-info">Lihat Mata Pelajaran</a>
                                            </td>
                                        </tr>
                                    <?php endwhile; ?>
                                <?php else : ?>
